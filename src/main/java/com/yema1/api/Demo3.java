...
public class Demo3 {
	...
	public void fun3(){
		...
		Customer customer = (Customer) session.get(Customer.class, 1l);//实体中id是Long型的，所以这里是1l（L）
